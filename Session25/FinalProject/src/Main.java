...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n\n=============================================");
        System.out.println("=== BENCHMARKING WAKTU EKSEKUSI PENCARIAN ===");
        System.out.println("=============================================");
        String targetNim = "2501008"; // NIM target 

        // Pengujian Waktu Pencarian pada Hash Table
        long startTimeHash = System.nanoTime();
        Mahasiswa resHash = hashTable.cariMahasiswa(targetNim);
        long endTimeHash = System.nanoTime();
        long durationHash = endTimeHash - startTimeHash;

        // Pengujian Waktu Pencarian pada Binary Search Tree (BST)
        long startTimeBST = System.nanoTime();
        Mahasiswa resBST = bst.search(targetNim);
        long endTimeBST = System.nanoTime();
        long durationBST = endTimeBST - startTimeBST;

        // Menampilkan Hasil Perbandingan
        System.out.println("Mencari NIM: " + targetNim);
        System.out.println("Waktu pencarian Hash Table : " + durationHash + " ns");
        System.out.println("Waktu pencarian BST        : " + durationBST + " ns");
        
        System.out.println("\nSelisih Waktu: " + Math.abs(durationHash - durationBST) + " ns");
        if (durationHash < durationBST) {
            System.out.println("Kesimpulan: Hash Table lebih cepat dari BST.");
        } else if (durationBST < durationHash) {
            System.out.println("Kesimpulan: BST lebih cepat dari Hash Table.");
        } else {
            System.out.println("Kesimpulan: Waktu eksekusi relatif sama.");
        }
    }
